    ...
    <div className="bg-luxury-warm min-h-screen">
      <section className="relative pt-40 pb-32 flex items-center justify-center">
        <div className="absolute inset-0 z-0">
           <Image src="https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?q=80&w=2070&auto=format&fit=crop" alt="Premium Roofing" fill className="object-cover" />
            ...
            <div className="bg-luxury-dark text-luxury-white rounded-sm p-12 lg:p-20 shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                 ...
                 <div className="relative h-80 lg:h-full min-h-[400px] rounded-sm overflow-hidden">
                    <Image src="https://images.unsplash.com/photo-1543884175-9c869910d6e8?q=80&w=1964&auto=format&fit=crop" alt="Quality Standard" fill className="object-cover" />
                 </div>
              </div>
            </div>
         </div>
